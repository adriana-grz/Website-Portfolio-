    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 mb-6">
          ...
          <span className="px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-[10px] uppercase tracking-[0.2em] font-bold text-white/70">
        ...
        <motion.h1 
          ...
          className="text-7xl md:text-9xl font-bold text-white mb-8 tracking-tighter leading-[0.85]"
        >
          WEB <br /> 
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-6">
          <div className="max-w-2xl space-y-4">
            ...
            <p className="text-lg md:text-xl text-white/40 leading-relaxed font-normal">
              ...
              I love the process of turning heffort into something that actually works.

            </p>
          </div>
          
          {/* Social Links */}
          <div className="flex items-center gap-8 mt-4 relative z-30 pointer-events-auto">
            {[
        ...
        <motion.div variants={itemVariants} className="flex gap-5 mt-12 pointer-events-auto">
          <button className="group relative px-8 py-4 rounded-full overflow-hidden transition-all bg-white hover:scale-105 active:scale-95">
            <span className="relative text-black font-bold text-sm uppercase tracking-wider">Explore Projects</span>
          </button>
          
          <button className="px-8 py-4 rounded-full border border-white/20 bg-white/5 backdrop-blur-lg text-white font-bold text-sm uppercase tracking-wider hover:bg-white/10 transition-all hover:scale-105 active:scale-95">
            Get in touch
          </button>
        </motion.div>
      </motion.div>
